...
# Keep machine-local cache/model overrides out of version control. If needed, pass
# a local path with the model argument or set TRANSFORMERS_CACHE/HF_HOME outside
# the repository.
MODEL_LOAD_OVERRIDES: Dict[str, str] = {}
