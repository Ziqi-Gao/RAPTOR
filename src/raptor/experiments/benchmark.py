...
from raptor.experiments.run_embeddings import run_embeddings
from raptor.experiments.run_gcs import run_gcs_experiments
from raptor.experiments.run_raptor import run_singlelr_experiments
from raptor.experiments.run_xrfm import run_xrfm_experiments
...
def main() -> None:
    ...
    if "singlelr" in methods or "raptor" in methods:
